...
const SignUpPage = ({ route: routeProp }) => {
        ...
        if (!isChecked) {
            ...
            if (id !== undefined && id !== '') {
                try {
                    ...
                    const response = await axios.post(`${apiUrl}/updateUserData`, formData, {
                        headers: {
                ...
                try {
                    // Make a POST request to your backend API using Axios
                    const response = await axios.post(`${apiUrl}/addUserData`, formData, {
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    });
            ...
            {step === 1 && (
                <View style={styles.container}>
                    <View style={styles.startingScreen}>
                        ...
                        <Text style={styles.tagline}>On </Text>
